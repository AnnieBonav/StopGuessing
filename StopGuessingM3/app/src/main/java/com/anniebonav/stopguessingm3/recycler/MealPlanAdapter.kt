...
class MealPlanAdapter (private val context: Context, _mealPlansArrayList: List<MealPlan>, private val onDeleteClick: MPDeleteClickFunction, private val onCardClick: MPOpenClickFunction): RecyclerView.Adapter<MealPlanViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MealPlanViewHolder {
        ...
        return MealPlanViewHolder(view, onDeleteClick, onCardClick)
    }
